---
description: Step-06 project initiation - generate AI-TOOL-GUIDE.md and adapter files
allowed-tools: Read, Write, Edit, Glob, Bash(git:*), Bash(gh:*), Bash(az:*), Bash(glab:*)
---

# Project Init AI Tool Guide

Run the shared Project Initiation workflow for Step-06.
...
If any file fails to load, halt execution and output: `Error: <filename> could not be loaded. Resolve this before continuing Step-06.`
