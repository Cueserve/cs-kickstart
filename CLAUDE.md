...
run the 8-step initiation process. (Step-06 generates a *downstream* CLAUDE.md for
...
load from this kit. `/proj-init-cleanup` clears the state after Step-08 merges. When you
