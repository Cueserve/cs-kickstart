---
agent: agent
description: Step-07 project initiation - replace boilerplate README.md
---

# Project Init README

Run the shared Project Initiation workflow for Step-07.
...
If any file fails to load, halt execution and output: `Error: <filename> could not be loaded. Resolve this before continuing Step-07.`
