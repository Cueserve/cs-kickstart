---
agent: agent
description: Step-03 project initiation - generate PRD.md
---

# Project Init PRD

Run the shared Project Initiation workflow for Step-03.
...
If any file fails to load, halt execution and output: `Error: <filename> could not be loaded. Resolve this before continuing Step-03.`
